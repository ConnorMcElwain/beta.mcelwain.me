...
Here I will talk about why I'm learning/doing a full MECM install and setup. Why I'm rebuilding a test version of this in my homelab and why I'm doing this for work.
### The Set Up
...
### The Prerequisites
[Configuration Manager Prerequisites Tool](https://msendpointmgr.com/configmgr-prerequisites-tool/#:~:text=ConfigMgr%20Prerequisites%20Tool%20is%20designed%20to%20help)

First download and install the prerequisite tool on the Primary Server. Within the Sites section, click Site Type, select Primary Site, then click install.
